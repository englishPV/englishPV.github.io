...
.glassmorphism, .glassmorphism-menu {
...
:where(button, input, select):focus-visible {
  box-shadow: 0 0 0 2px var(--brand), 0 0 0 4px rgba(16, 185, 129, 0.25);
  border-color: transparent !important;
}
button {
  transition: transform 0.15s var(--easing), opacity 0.2s;
  min-height: 40px;
}
button:hover {
...
#flashcard-container {
  transition: background-color 0.35s var(--easing), border-color 0.35s var(--easing), color 0.35s var(--easing);
}
